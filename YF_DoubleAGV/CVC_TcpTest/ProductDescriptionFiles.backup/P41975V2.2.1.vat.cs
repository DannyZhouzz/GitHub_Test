...
{
    public class P41975V2_2_1 : WizardScriptBase3
    {
        ...
        //DCT files
        string ACD_Small_DCT = "P41885V1.3.4";
        string ACD_Medium_DCT = "P41874V1.3.3";
        string ACS_DCT = "P41883V1.3.2";
        string DCD_Small_DCT = "P46007V1.0.3";
        string DCD_Medium_DCT = "P46009V1.0.3";
        string DCD_Large_DCT = "P46020V1.0.3";
        string BUILTIN_SDIO_DCT = "P41977V1.2.0";
        ...
        public override void SetNavigationType(string navigationType)
        {
            ...
            try
            {
                ComponentData spotNavigator, vehicleNavigator, wireNavigator, wallNavigator, ndtNavigator;
